...
import com.example.dagna.meetapp.FavoriteObject;
 ...
 */
public class FavoriteAdapter extends ArrayAdapter<FavoriteObject> {
    public final static String EXTRA_MESSAGE = "com.example.dagna.meetapp.MESSAGE";


    Context context;
    public FavoriteAdapter(Context context, ArrayList<FavoriteObject> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        final FavoriteObject e = getItem(position);
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.favorite_list_item, parent, false);
        }
        ImageView imageView = (ImageView) convertView.findViewById(R.id.favorite_image);
        TextView title = (TextView) convertView.findViewById(R.id.title);
        TextView description = (TextView) convertView.findViewById(R.id.description);


        if(e.getImageRef()!=null) {
            Log.d("FavoriteAdapter","ref not null");
